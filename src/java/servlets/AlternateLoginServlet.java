...
public class AlternateLoginServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (request.getParameter("uuid") != null) {
            ...
            getServletContext().getRequestDispatcher("/WEB-INF/altLogin.jsp").forward(request, response);
            return;
        }
